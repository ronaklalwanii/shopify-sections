function m(o, t, i) {
	...
	return o && (e.className = o), i && i.appendChild(e), e
}
function u(o, t) {
...
function b(o, t, i) {
	let e = `translate3d(${o}px,${t || 0}px,0)`
	return i !== void 0 && (e += ` scale3d(${i},${i},1)`), e
}
function v(o, t, i, e) {
	o.style.transform = b(t, i, e)
}
var mt = 'cubic-bezier(.4,0,.22,1)'
function at(o, t, i, e) {
	o.style.transition = t ? `${t} ${i}ms ${e || mt}` : 'none'
}
function C(o, t, i) {
	;(o.style.width = typeof t == 'number' ? `${t}px` : t),
		(o.style.height = typeof i == 'number' ? `${i}px` : i)
}
function ft(o) {
	at(o)
}
function _t(o) {
	return 'decode' in o
		...
		? Promise.resolve(o)
		: new Promise((t, i) => {
				;(o.onload = () => t(o)), (o.onerror = i)
		  })
}
var f = { IDLE: 'idle', LOADING: 'loading', LOADED: 'loaded', ERROR: 'error' }
function gt(o) {
	return (
		('button' in o && o.button === 1) ||
		o.ctrlKey ||
		o.metaKey ||
		o.altKey ||
		o.shiftKey
...
function yt(o, t, i = document) {
	let e = []
	if (o instanceof Element) e = [o]
	else if (o instanceof NodeList || Array.isArray(o)) e = Array.from(o)
	else {
		let s = typeof o == 'string' ? o : t
...
function lt(o, t) {
	if (o.getViewportSizeFn) {
		let i = o.getViewportSizeFn(o, t)
		if (i) return i
	}
	return { x: document.documentElement.clientWidth, y: window.innerHeight }
}
function S(o, t, i, e, s) {
	let n = 0
	if (t.paddingFn) n = t.paddingFn(i, e, s)[o]
	else if (t.padding) n = t.padding[o]
	else {
		let r = 'padding' + o[0].toUpperCase() + o.slice(1)
		t[r] && (n = t[r])
	}
	return Number(n) || 0
}
function ct(o, t, i, e) {
	return {
		x: t.x - S('left', o, t, i, e) - S('right', o, t, i, e),
		y: t.y - S('top', o, t, i, e) - S('bottom', o, t, i, e),
	}
}
var z = class {
		constructor(t) {
		...
		_updateAxis(t) {
			...
			;(this.center[t] = Math.round((r - e) / 2) + n),
				(this.max[t] = e > r ? Math.round(r - e) + n : this.center[t]),
				(this.min[t] = e > r ? n : this.center[t])
		}
		reset() {
			;(this.center.x = 0),
				(this.center.y = 0),
	...
	O = class {
		constructor(t, i, e) {
			;(this.data = t),
				...
				(this.zoomLevels = new A(e.options, t, i, e)),
				...
				(this.container = m('pswp__zoom-wrap', 'div')),
		...
		sizeChanged(t, i) {
			return t !== this.prevDisplayedWidth ||
		...
		zoomAndPanToInitial() {
			;(this.currZoomLevel = this.zoomLevels.initial),
				this.bounds.update(this.currZoomLevel),
				u(this.pan, this.bounds.center),
				this.pswp.dispatch('initialZoomPan', { slide: this })
		}
		_applyZoomTransform(t, i, e) {
			;(e /= this.currentResolution || this.zoomLevels.initial),
				v(this.container, t, i, e)
		}
		calculateSize() {
			let { pswp: t } = this
			u(
				this.panAreaSize,
				ct(t.options, t.viewportSize, this.data, this.index),
			),
...
var E = class {
		...
		start() {
			this.pswp.currSlide && u(this.startPan, this.pswp.currSlide.pan),
		...
		change() {
			...
			if (
				...
				if (
					!this.pswp.dispatch('verticalDrag', { panY: n })
						.defaultPrevented
				) {
					this._setPanWithFriction('y', n, wt)
					let r = 1 - Math.abs(this._getVerticalDragRatio(s.pan.y))
			...
			if ((this.pswp.animations.stopAll(), i.isShifted())) {
				let r = (i.x - i.getCurrSlideX()) / this.pswp.viewportSize.x
				;(t.x < -et && r < 0) || (t.x < 0.1 && r < -0.5)
		...
		_finishPanGestureForAxis(t) {
			...
			let { pan: s, bounds: n } = e,
				...
				h = r + Pt(i[t], l)
			if (a) {
				let g = this._getVerticalDragRatio(r),
					w = this._getVerticalDragRatio(h)
				if ((g < 0 && w < -it) || (g > 0 && w > it)) {
					this.pswp.close()
					return
				}
			}
			let c = n.correctPan(t, h)
			if (r === c) return
			let d = c === h ? 1 : 0.82,
			...
			this.pswp.animations.startSpring({
				...
				onUpdate: g => {
					if (a && this.pswp.bgOpacity < 1) {
						let w = 1 - (c - g) / _
						this.pswp.applyBgOpacity(I(p + (1 - p) * w, 0, 1))
					}
		...
		_panOrMoveMainScroll(t) {
			let {
				...
				{ currSlide: r, mainScroll: a } = this.pswp,
				l = i[t] - s[t],
				h = a.x + l
			if (!l || !r) return !1
			if (t === 'x' && !r.isPannable() && !n) return a.moveTo(h, !0), !0
			let { bounds: c } = r,
				d = r.pan[t] + l
			if (
				...
				let p = a.getCurrSlideX(),
					_ = a.x - p,
					g = l > 0,
					w = !g
				if (d > c.min[t] && g) {
					if (c.min[t] <= this.startPan[t]) return a.moveTo(h, !0), !0
					this._setPanWithFriction(t, d)
				} else if (d < c.max[t] && w) {
					if (this.startPan[t] <= c.max[t]) return a.moveTo(h, !0), !0
					this._setPanWithFriction(t, d)
				} else if (_ !== 0) {
					if (_ > 0) return a.moveTo(Math.max(h, p), !0), !0
					if (_ < 0) return a.moveTo(Math.min(h, p), !0), !0
		...
		_setPanWithFriction(t, i, e) {
			...
			if (!s) return
			let { pan: n, bounds: r } = s
			if (r.correctPan(t, i) !== i || e) {
				let l = Math.round(i - n[t])
				n[t] += l * (e || vt)
			} else n[t] = i
		}
	},
	...
	xt = 0.15
function st(o, t, i) {
	return (o.x = (t.x + i.x) / 2), (o.y = (t.y + i.y) / 2), o
}
var Z = class {
	constructor(t) {
		;(this.gestures = t),
	...
	start() {
		...
		t &&
			((this._startZoomLevel = t.currZoomLevel),
			u(this._startPan, t.pan)),
	...
	change() {
		let { p1: t, startP1: i, p2: e, startP2: s, pswp: n } = this.gestures,
			{ currSlide: r } = n
		if (!r) return
		let a = r.zoomLevels.min,
			l = r.zoomLevels.max
		if (!r.isZoomable() || n.mainScroll.isShifted()) return
		st(this._startZoomPoint, i, s), st(this._zoomPoint, t, e)
		let h = (1 / L(i, s)) * L(t, e) * this._startZoomLevel
		if (
			(h > r.zoomLevels.initial + r.zoomLevels.initial / 15 &&
			...
			if (
				...
				this._startZoomLevel <= r.zoomLevels.initial
			) {
				let c = 1 - (a - h) / (a / 1.2)
		...
		;(r.pan.x = this._calculatePanForZoomLevel('x', h)),
			(r.pan.y = this._calculatePanForZoomLevel('y', h)),
			r.setZoomLevel(h),
			r.applyCurrentZoomPan()
	}
	end() {
	...
	_calculatePanForZoomLevel(t, i) {
		...
		return (
			this._zoomPoint[t] -
			(this._startZoomPoint[t] - this._startPan[t]) * e
		)
	}
	correctZoomPan(t) {
			...
			i.animations.startSpring({
				...
				onUpdate: p => {
					if (((p /= 1e3), d || r)) {
						if (
							(d &&
								((e.pan.x = h.x + (c.x - h.x) * p),
								(e.pan.y = h.y + (c.y - h.y) * p)),
							r)
						) {
							let _ = s + (n - s) * p
							e.setZoomLevel(_)
					...
					l &&
						i.bgOpacity < 1 &&
						i.applyBgOpacity(I(a + (1 - a) * p, 0, 1))
				},
				onComplete: () => {
					e._setResolution(n), e.applyCurrentZoomPan()
				},
...
function nt(o) {
	return !!o.target.closest('.pswp__container')
}
var D = class {
		constructor(t) {
			this.gestures = t
		...
		_doClickOrTapAction(t, i, e) {
			let { pswp: s } = this.gestures,
				...
				a = s.options[r]
			if (
				!s.dispatch(r, { point: i, originalEvent: e }).defaultPrevented
			) {
	...
	M = class {
		...
		_bindEvents(t, i, e, s) {
			let { pswp: n } = this,
				{ events: r } = n,
				a = s ? t + s : ''
			r.add(n.scrollWrap, t + i, this.onPointerDown.bind(this)),
				r.add(window, t + 'move', this.onPointerMove.bind(this)),
				r.add(window, t + e, this.onPointerUp.bind(this)),
				a && r.add(n.scrollWrap, a, this.onPointerUp.bind(this))
		}
		onPointerDown(t) {
			...
			e.dispatch('pointerDown', { originalEvent: t }).defaultPrevented ||
				(i &&
					(e.mouseDetected(), this._preventPointerEventBehaviour(t)),
				e.animations.stopAll(),
				this._updatePoints(t, 'down'),
				this._numActivePoints === 1 &&
					((this.dragAxis = null), u(this.startP1, this.p1)),
				this._numActivePoints > 1
		...
		_finishTap(t) {
			...
			this._tapTimer
				? (this._clearTapTimer(),
				  L(this._lastStartP1, this.startP1) < At &&
						this.tapHandler.doubleTap(this.startP1, t))
				: (u(this._lastStartP1, this.startP1),
		...
		_updatePoints(t, i) {
			if (this._pointerEventEnabled) {
				let e = t,
					s = this._ongoingPointers.findIndex(
						n => n.id === e.pointerId,
					)
				i === 'up' && s > -1
					...
					: s > -1 &&
					  this._convertEventPosToPoint(e, this._ongoingPointers[s]),
					(this._numActivePoints = this._ongoingPointers.length),
					this._numActivePoints > 0 &&
						u(this.p1, this._ongoingPointers[0]),
					this._numActivePoints > 1 &&
						u(this.p2, this._ongoingPointers[1])
			} else {
				let e = t
				;(this._numActivePoints = 0),
		...
		_updateStartPoints() {
			u(this.startP1, this.p1),
				u(this.startP2, this.p2),
				this._updatePrevPoints()
		}
		_calculateDragDirection() {
			if (this.pswp.mainScroll.isShifted()) this.dragAxis = 'x'
				...
				if (t !== 0) {
					let i = t > 0 ? 'x' : 'y'
					Math.abs(this.p1[i] - this.startP1[i]) >= bt &&
						(this.dragAxis = i)
				}
			}
		}
	...
	R = class {
		...
		resize(t) {
			...
			s && ((this.slideWidth = e), this.moveTo(this.getCurrSlideX())),
				this.itemHolders.forEach((n, r) => {
					s &&
						v(
							n.el,
							(r + this._containerShiftIndex) * this.slideWidth,
						),
		...
		appendHolders() {
			this.itemHolders = []
			for (let t = 0; t < 3; t++) {
				let i = m('pswp__item', 'div', this.pswp.container)
		...
		updateCurrItem() {
			...
			let e = Math.abs(i),
				s
			e >= 3 &&
				((this._containerShiftIndex += i + (i > 0 ? -3 : 3)), (e = 3))
			for (let n = 0; n < e; n++)
				i > 0
					? ((s = this.itemHolders.shift()),
					  s &&
							...
							v(
								s.el,
								(this._containerShiftIndex + 2) *
									this.slideWidth,
							),
							t.setContent(s, t.currIndex - e + n + 2)))
			...
			Math.abs(this._containerShiftIndex) > 50 &&
				...
				this.itemHolders.forEach((n, r) => {
					n.slide && n.slide.setIsActive(r === 1)
				}),
		...
		moveTo(t, i) {
			...
			;(this.x = t),
				this.pswp.container && v(this.pswp.container, t),
		...
		easeFrame(t, i) {
			...
			if (this._dampingRatio === 1)
				...
				s =
					...
					(this._dampingRatio * this._naturalFrequency * t +
						this.velocity)
				let r = Math.cos(this._dampedFrequency * i),
					a = Math.sin(this._dampedFrequency * i)
				;(e = n * (t * r + s * a)),
					(this.velocity =
						e * -this._naturalFrequency * this._dampingRatio +
						n *
							(-this._dampedFrequency * t * a +
								this._dampedFrequency * s * r))
			}
			return e
		}
	},
	k = class {
		constructor(t) {
			...
			let c = new N(s, l, h),
				...
				_ = () => {
					this._raf &&
						((p = c.easeFrame(p, Date.now() - d)),
						Math.abs(p) < 1 && Math.abs(c.velocity) < 50
							? (n(e), r && r(), this.onFinish())
							: ((d = Date.now()),
							  n(p + e),
				...
				if (t.ctrlKey || this.pswp.options.wheelToZoom) {
					if (i.isZoomable()) {
						...
						t.deltaMode === 1
							...
							(n = 2 ** n)
						let r = i.currZoomLevel * n
						i.zoomTo(r, { x: t.clientX, y: t.clientY })
					}
				} else
					i.isPannable() &&
...
var V = class {
	constructor(t, i) {
		let e = i.name || i.className,
			s = i.html
		if (t.options[e] === !1) return
		typeof t.options[e + 'SVG'] == 'string' && (s = t.options[e + 'SVG']),
			t.dispatch('uiElementCreate', { data: i })
		let n = ''
		i.isButton
			? ((n += 'pswp__button '),
			  (n += i.className || `pswp__button--${i.name}`))
			: (n += i.className || `pswp__${i.name}`)
		let r = i.isButton ? i.tagName || 'button' : i.tagName || 'div'
		r = r.toLowerCase()
		let a = m(n, r)
		if (i.isButton) {
			r === 'button' && (a.type = 'button')
			let { title: c } = i,
				{ ariaLabel: d } = i
			typeof t.options[e + 'Title'] == 'string' &&
				(c = t.options[e + 'Title']),
				c && (a.title = c)
			let p = d || c
		...
		;(a.innerHTML = Et(s)),
			i.onInit && i.onInit(a, t),
			i.onClick &&
				(a.onclick = c => {
					typeof i.onClick == 'string'
						? t[i.onClick]()
						: typeof i.onClick == 'function' && i.onClick(c, a, t)
				})
		...
		l === 'bar'
			...
			: (a.classList.add('pswp__hide-on-close'),
			  l === 'wrapper' && (h = t.scrollWrap)),
			h?.appendChild(t.applyFilters('uiElement', a, i))
	}
}
function dt(o, t, i) {
	o.classList.add('pswp__button--arrow'),
		o.setAttribute('aria-controls', 'pswp__items'),
		t.on('change', () => {
			t.options.loop ||
				(i
					? (o.disabled = !(t.currIndex < t.getNumItems() - 1))
					: (o.disabled = !(t.currIndex > 0)))
		})
}
var Zt = {
		name: 'arrowPrev',
	...
	Ft = {
		...
		onInit: (o, t) => {
			let i,
				e = null,
				s = (a, l) => {
					o.classList.toggle('pswp__preloader--' + a, l)
				},
				n = a => {
					i !== a && ((i = a), s('active', a))
				},
				r = () => {
					...
					e ||
						(e = setTimeout(() => {
							n(!!t.currSlide?.content.isLoading()), (e = null)
...
function kt(o, t, i) {
	let e = o.getBoundingClientRect(),
		...
		a = (e.width - t * r) / 2,
		l = (e.height - i * r) / 2,
		h = { x: e.left + a, y: e.top + l, w: t * r }
	return (h.innerRect = { w: e.width, h: e.height, x: a, y: l }), h
}
function Wt(o, t, i) {
	let e = i.dispatch('thumbBounds', { index: o, itemData: t, instance: i })
	...
	return (
		(r = i.applyFilters('thumbEl', r, t, o)),
		r &&
			(t.thumbCropped
				? (n = kt(r, t.width || t.w || 0, t.height || t.h || 0))
				: (n = Nt(r))),
		i.applyFilters('thumbBounds', n, t, o)
	)
}
var q = class {
		constructor(t, i) {
	...
	G = class {
		...
		addFilter(t, i, e = 100) {
			this._filters[t] || (this._filters[t] = []),
				this._filters[t]?.push({ fn: i, priority: e }),
				this._filters[t]?.sort((s, n) => s.priority - n.priority),
		...
		off(t, i) {
			this._listeners[t] &&
				(this._listeners[t] = this._listeners[t].filter(e => i !== e)),
				this.pswp?.off(t, i)
		}
		dispatch(t, i) {
	...
	K = class {
		...
		load(t, i) {
			...
			;(this.element && !i) ||
				...
				(this.isImageContent()
					? ((this.element = m('pswp__img', 'img')),
					  this.displayedImageWidth && this.loadImage(t))
					: ((this.element = m('pswp__content', 'div')),
		...
		onLoaded() {
			;(this.state = f.LOADED),
				this.slide &&
					...
					(this.state === f.LOADED || this.state === f.ERROR) &&
	...
	Ht = 5
function pt(o, t, i) {
	let e = t.createContentFromData(o, i),
		s,
		{ options: n } = t
	if (n) {
		s = new A(n, o, -1)
		let r
		t.pswp ? (r = t.pswp.viewportSize) : (r = lt(n, t))
		let a = ct(n, r, o, i)
...
function Vt(o, t) {
	let i = t.getItemData(o)
	if (
		!t.dispatch('lazyLoadSlide', { index: o, itemData: i }).defaultPrevented
	)
		return pt(i, t, o)
}
var Y = class {
	...
	j = class {
		...
		_applyStartProps() {
			...
			if (
				...
				(this._useAnimation = !!(
					this._duration && this._duration > 50
				)),
				(this._animateZoom =
					!!this._thumbBounds &&
				...
				this._animateZoom
					? (this._animateRootOpacity = e.showHideOpacity ?? !1)
			...
			this._thumbBounds.innerRect
				...
				this.isOpening
					? (this._animateRootOpacity
							? (t.element &&
									(t.element.style.opacity = String(P)),
							  t.applyBgOpacity(1))
							: (this._animateBgOpacity &&
									t.bg &&
					  ...
					  this._animateZoom &&
							...
							this._placeholder &&
								((this._placeholder.style.willChange =
									'transform'),
		...
		_setClosedStateZoomPan(t) {
			...
			if (
				...
				let r = -n.x + (this._thumbBounds.x - e.x) + e.w,
				...
				t
					...
					: (v(this._cropContainer1, r, a),
					  v(this._cropContainer2, l, h))
			}
			s &&
				(u(s.pan, e || this._thumbBounds),
	...
	Q = class extends $ {
		...
		updateSize(t) {
			...
			;(!t && x(i, this._prevViewportSize)) ||
				(u(this._prevViewportSize, i),
				this.dispatch('beforeResize'),
				u(this.viewportSize, this._prevViewportSize),
		...
		_createMainStructure() {
			;(this.element = m('pswp', 'div')),
				this.element.setAttribute('tabindex', '-1'),
				this.element.setAttribute('role', 'dialog'),
				(this.template = this.element),
				(this.bg = m('pswp__bg', 'div', this.element)),
				(this.scrollWrap = m(
					'pswp__scroll-wrap',
					'section',
					this.element,
				)),
				(this.container = m('pswp__container', 'div', this.scrollWrap)),
