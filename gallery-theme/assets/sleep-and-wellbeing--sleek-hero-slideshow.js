  ...
  customElements.define(
    ...
    class SlideshowComponent extends HTMLElement {
      ...
      handleSlideChange(swiper) {
        ...
        // Swiper 9+ loop mode can emit slideChange while slides are being
        // reordered, leaving slides[activeIndex] undefined for a tick. Throw
        // here and the emit chain dies before updateSlidesClasses() runs,
        // which freezes the slider on the current slide.
        const activeSlide = slides && slides[activeIndex];
        if (activeSlide) {
          this.updateControlsScheme(activeSlide);
        }
      }
